 ...
 * @author raphael
 */
public class AddedWindowPane extends AddedAccessoryPane {
    
    public AddedWindowPane(UUID id, Mur.orientations orientation, MainWindow parent) {
        super(id, "Fenêtre", parent);
        ...
        //this.hauteur.setText(accessoire.HauteurContour);
    }
    ...
    private void initComponents(){
       ...
       /* ActionListener CBoxLinteauActionListener = new ActionListener(){
         @Override
        ...
        LinteauComboBox.addActionListener(CBoxLinteauActionListener);*/
    }
    ...
    private void OkActionPerformed(java.awt.event.ActionEvent evt){
      ...
      /*  private void OkMontantActionPerformed(java.awt.event.ActionEvent evt){
       ...
       /* private void ok2ActionPerformed(java.awt.event.ActionEvent evt){
        String espacement = this.getText();
        double nouvelleLargeur = Double.parseDouble(largeur);
        double nouvelleHauteur = Double.parseDouble(hauteur);
        this.controlleur.setHauteurAccessoire(this.getOrientation(), this.getID(), nouvelleHauteur);
        this.controlleur.setLargeurAccessoire(this.getOrientation(), this.getID(), nouvelleLargeur);
